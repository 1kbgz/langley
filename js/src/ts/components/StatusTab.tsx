...
export function StatusTab({
  ...
  return (
    <>
      ...
      <div className="langley-content-grid">
        <div className="langley-content-main">
          <AgentTable agents={filteredAgents} onAction={handleAction} onChat={onNavigateChat} />
        </div>
        <aside className="langley-content-aside">

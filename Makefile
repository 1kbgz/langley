...
lint-py:  ## run python linter with ruff
	python -m ruff check langley
	python -m ruff format --check langley
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix langley
	python -m ruff format langley
...
test-py:  ## run python tests
	python -m pytest -v langley/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v langley/tests --cov=langley --cov-report term-missing --cov-report xml
